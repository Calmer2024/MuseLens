...
- 也适合“保留人物和大构图，主要替换场景/背景氛围”的任务，例如把原本普通街景改成巴黎埃菲尔铁塔、雪山、海边黄昏，只要允许主体细节做轻微语义重绘而不是像抠图那样绝对锁死。
...
- 如果任务要求“主体身份、服装、面部一律不变，只换背景”，且库里已有更强的 reference-latent 或多约束重绘透镜，应优先考虑那些参考约束链路。
